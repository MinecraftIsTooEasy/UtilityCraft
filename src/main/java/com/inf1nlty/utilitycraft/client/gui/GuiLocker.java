...
public class GuiLocker extends GuiContainer {
    ...
    private static final ResourceLocation TEX = new ResourceLocation("utilitycraft:textures/gui/chestAncientMetal_gui.png");
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        String titleKey = inv.getCustomNameOrUnlocalized();
        String title = inv.hasCustomName() ? titleKey : I18n.getString(titleKey);
